...
%include "lib/io/print_ascii.asm"
...
; void rand_int(signed long {rdi}, signed long {rsi});
...
START:
	...
	; parse input password length from command line input
	mov rdi,[SYS_ARGC_START_POINTER+16]
	call parse_int
	mov rcx,rax

	; ignore some bogus inputs
	cmp rax,0
	jle .exit
...
.loop:
	...
	mov rdi,33
	mov rsi,126
	call rand_int	; random value in {rax}
