...
; computes Taylor series polynomial approximation of cosine({xmm0})
...
; adjust input xmm0 to within range -pi to +pii
...
.get_ready:
	...
	mov rcx,0				; track polynomial order in rcx
	mov rdx,1				; track factorial denominator in rdx
	cvtsi2sd xmm0,rdx		; first term in series is 1.0f
