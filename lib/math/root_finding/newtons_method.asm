...
newtons_method:
; ulong {rax}, double {xmm0} newtons_method(void* {rdi}, double {xmm0}, 
;					double {xmm1});
;	Uses Newton's method to find a root for the single-variable 
;	function at address {rdi} with initial guess {xmm0} to within
;	tolerance {xmm2}. On fail, {rax}=0. On success, the root 
;	is returned in {xmm0}, and {rax} contains the number of 
;	iterations.
;
