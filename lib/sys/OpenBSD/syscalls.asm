...
%define SYS_CHMOD 15
%define SYS_IOCTL 54
%define SYS_GETTIMEOFDAY 67 ; differs from FreeBSD
%define SYS_LSEEK 166 ; differs from FreeBSD
%define SYS_GETRANDOM 7 ; "getEntropy"
...
; pointer to argc at program start TODO: check
%define SYS_ARGC_START_POINTER rsp

%macro SYS_PUSH_SYSCALL_CLOBBERED_REGISTERS 0 ; TODO: check
	push rcx
	push r8
	push r9
	push r10
