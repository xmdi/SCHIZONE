...
FILE_GIVEN:
	...
	__LSEEK X0, 160, SYS_SEEK_SET // LSEEK TO BYTE 160 FROM FILE START
	LDR X0,[SP,0]
	__READ X0, .IMAGE_SIZE, 8 // READ 8 BYTES
...
.CONTINUE:
	...
	// READ DATA FROM BOOMER FILE
	LDP X0,X1,[SP,0]
	__READ X0, .BUFFER, BUFFER_SIZE

	// COPY DATA INTO OUTPUT BINARY
	__WRITE X1, .BUFFER, BUFFER_SIZE
