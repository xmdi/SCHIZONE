...
START:
	...
	mov rsi,SYS_CREATE_FILE	; put CREATE_ONLY flags in {rsi}
	mov rdx,SYS_DEFAULT_PERMISSIONS	; default R/W flags in {rdx}
	call file_open		; call function to open file
	; {rax} contains new file descriptor

	mov rdi,rax
	call file_close		; call function to close file
