...
%include "lib/io/framebuffer/framebuffer_3d_render_depth_perspective_init.asm"

;%include "lib/io/framebuffer/framebuffer_3d_render_depth_perspective_loop.asm"
...
START:
	...
	call framebuffer_3d_render_depth_perspective_init
...
.perspective_structure:
	...
	dq 1.0 ; upDir_z	
	dq 0.3	; zoom
	dq 0.5	; depth from lookFrom to view plane [+80]
...
.faces_top:
	...
	dq 9,12,8,0x1FF00FF00 ; top front
	dq 9,13,12,0x1FF00FF00 ; top front

	dq 11,15,10,0x1FFFFFFFF ; top back
	dq 10,15,14,0x1FFFFFFFF ; top back
...
.faces_bottom:
	...
	dq 0,9,8,0x1FF00FF00 ; top front
	dq 0,1,9,0x1FF00FF00 ; top front

	dq 3,10,2,0x1FFFFFFFF ; top back
	dq 3,11,10,0x1FFFFFFFF ; top back
