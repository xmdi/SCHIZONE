...
line_fit_function: ; takes 1 double from [rsp+8] and evaluates line there
	sub rsp,16
	movdqu [rsp+0],xmm0
	movq xmm0,[rsp+24]
...
START:
	...
	mov rdi,line_fit_function.regression_coefficients
	mov rsi,.x_values
	mov rdx,.y_values
	mov rcx,6
	...
	mov rdi,SYS_STDOUT
	mov rsi,line_fit_function.regression_coefficients
	mov rdx,2
	mov rcx,1
	xor r8,r8
	mov r9,print_float
