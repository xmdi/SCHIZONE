...
START:
	...
	mov rsi,16		; number of elements to print above stack
	mov rdx,print_int_h	; function pointer for print
	push qword 777		; sample value on stack
	call print_stack
	add rsp,8

	mov rsi,ARRAY		; memory location to start dump
;	mov rdx,print_int_h	; function pointer for print
	mov rcx,15*8		; number of bytes
	call print_memory	
...
ARRAY:
	dq 1337,1776,420,69,100
	dq 200,300,400,500,600
	dq -52,-51,-50,-49,-48
