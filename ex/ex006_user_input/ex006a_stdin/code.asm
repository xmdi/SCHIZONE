...
START:
	...
	; print `I hope you make it to `
	mov rdi,SYS_STDOUT
	mov rsi,GREETING
	mov rdx,22
	call print_chars

	; get rid of newline in AGE_BUFFER
	mov rdi,AGE_BUFFER
	call strlen		; compute length of age
	dec rax
	mov byte [rax+AGE_BUFFER], 0 ; remove trailing newline
	call parse_int
	...
	; get rid of newline in NAME_BUFFER
	mov rdi,NAME_BUFFER
	call strlen		; compute length of name
	dec rax			; chop off trailing newline
