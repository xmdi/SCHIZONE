...
START:
	...
	mov rsi,TEXT			; address of text start
	mov rdx,ADDRESS_AFTER_TEXT-TEXT ; can use nasm to compute length of
						; string in bytes
	mov r15,1000000
