...
.scatter_title1:
	db `Random Yellow Pointcloud`,0

.scatter_title2:
	db `Random Aqua Pointcloud`,0

.scatter_title3:
	db `Random Magenta Pointcloud`,0

.scatter_title4:
	db `Random Orange Pointcloud`,0
...
.scatter_plot_structure1:
	dq .scatter_title1; address of null-terminated title string {*+0}
	...
	dq -20.0; plot origin y translation (double) {*+48}
	dq 20.0; plot origin z translation (double) {*+56}
	...
	dd 0xFFFFFF00; #XXXXXX title RGB font color {*+172}
	...
	db 2; title font size (px) {*+185}
	db 2; axis label font size (px) {*+186}
	db 1; tick label font size (px) {*+187}
...
.scatter_plot_structure2:
	dq .scatter_title2; address of null-terminated title string {*+0}
	dq .scatter_xlabel; address of null-terminated x-label string {*+8}
	dq .scatter_ylabel; address of null-terminated y-label string {*+16}
	dq .scatter_zlabel; address of null-terminated z-label string {*+24}
	dq .scatter_dataset_structure2; addr of linked list for datasets {*+32}
	dq 0.0; plot origin x translation (double) {*+40}
	dq 20.0; plot origin y translation (double) {*+48}
	dq 20.0; plot origin z translation (double) {*+56}
	dq 0.0; origin x-coord (double) {*+64}
	...
	dd 0xFF00FF00; #XXXXXX RGB y-axis color {*+164}
	dd 0xFF0000FF; #XXXXXX RGB z-axis color {*+168}
	dd 0xFF00FFFF; #XXXXXX title RGB font color {*+172}
	db 5; number of major x-ticks {*+176}
	db 5; number of major y-ticks {*+177}
	db 5; number of major z-ticks {*+178}
	db 2; minor subdivisions per x-tick {*+179}
...
.scatter_plot_structure3:
	dq .scatter_title3; address of null-terminated title string {*+0}
	dq .scatter_xlabel; address of null-terminated x-label string {*+8}
	dq .scatter_ylabel; address of null-terminated y-label string {*+16}
	dq .scatter_zlabel; address of null-terminated z-label string {*+24}
	dq .scatter_dataset_structure3; addr of linked list for datasets {*+32}
	dq 0.0; plot origin x translation (double) {*+40}
	dq -20.0; plot origin y translation (double) {*+48}
	dq -20.0; plot origin z translation (double) {*+56}
	dq 0.0; origin x-coord (double) {*+64}
	...
	dd 0xFF00FF00; #XXXXXX RGB y-axis color {*+164}
	dd 0xFF0000FF; #XXXXXX RGB z-axis color {*+168}
	dd 0xFFFF00FF; #XXXXXX title RGB font color {*+172}
	db 5; number of major x-ticks {*+176}
	db 5; number of major y-ticks {*+177}
	db 5; number of major z-ticks {*+178}
	db 2; minor subdivisions per x-tick {*+179}
...
.scatter_dataset_structure3:
	...
	dw 0; extra stride between marker type elements {*+74}
	dd 101; number of elements {*+76}
	dd 0xFF00FF; default #XXXXXX RGB marker color {*+80}
	db 5; default marker size (px) {*+84}
	db 3; default marker type (1-4) {*+85}
	db 0x00; flags: currently unused {*+86}

.scatter_plot_structure4:
	dq .scatter_title4; address of null-terminated title string {*+0}
	dq .scatter_xlabel; address of null-terminated x-label string {*+8}
	dq .scatter_ylabel; address of null-terminated y-label string {*+16}
	dq .scatter_zlabel; address of null-terminated z-label string {*+24}
	dq .scatter_dataset_structure4; addr of linked list for datasets {*+32}
	dq 0.0; plot origin x translation (double) {*+40}
	dq 20.0; plot origin y translation (double) {*+48}
	dq -20.0; plot origin z translation (double) {*+56}
	dq 0.0; origin x-coord (double) {*+64}
	...
	dd 0xFF00FF00; #XXXXXX RGB y-axis color {*+164}
	dd 0xFF0000FF; #XXXXXX RGB z-axis color {*+168}
	dd 0xFFFFA500; #XXXXXX title RGB font color {*+172}
	db 5; number of major x-ticks {*+176}
	db 5; number of major y-ticks {*+177}
	db 5; number of major z-ticks {*+178}
	db 2; minor subdivisions per x-tick {*+179}
